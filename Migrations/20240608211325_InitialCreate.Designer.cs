...
namespace APBD_6.Migrations
{
    ...
    [Migration("20240608211325_InitialCreate")]
            ...
            modelBuilder.Entity("APBD_6.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPatient = 1,
                            BirthDate = new DateTime(1999, 6, 8, 23, 13, 24, 784, DateTimeKind.Local).AddTicks(5612),
                            FirstName = "Jakub",
                            LastName = "Nowak"
                        },
                        new
                        {
                            IdPatient = 2,
                            BirthDate = new DateTime(2003, 6, 8, 23, 13, 24, 784, DateTimeKind.Local).AddTicks(5671),
                            FirstName = "Michal",
                            LastName = "Kowalski"
                        },
                        new
                        {
                            IdPatient = 3,
                            BirthDate = new DateTime(1997, 6, 8, 23, 13, 24, 784, DateTimeKind.Local).AddTicks(5674),
                            FirstName = "Patient",
                        ...
                        {
                            IdPatient = 4,
                            BirthDate = new DateTime(2002, 6, 8, 23, 13, 24, 784, DateTimeKind.Local).AddTicks(5676),
                            FirstName = "Sergio",
                            LastName = "Kotowich"
                        },
                        new
                        {
                            IdPatient = 5,
                            BirthDate = new DateTime(1974, 6, 8, 23, 13, 24, 784, DateTimeKind.Local).AddTicks(5678),
                            FirstName = "Ala",
                            LastName = "Peronska"
                        },
                        new
                        {
                            IdPatient = 6,
                            BirthDate = new DateTime(1995, 6, 8, 23, 13, 24, 784, DateTimeKind.Local).AddTicks(5682),
                            FirstName = "Kot",
                            LastName = "Zygmund"
                        },
                        new
                        {
                            IdPatient = 7,
                            BirthDate = new DateTime(1970, 6, 8, 23, 13, 24, 784, DateTimeKind.Local).AddTicks(5684),
                            FirstName = "Natiel",
                            LastName = "Patient"
                        },
                        new
                        {
                            IdPatient = 8,
                            BirthDate = new DateTime(1957, 6, 8, 23, 13, 24, 784, DateTimeKind.Local).AddTicks(5686),
                            FirstName = "Jas",
                            LastName = "Profase"
                        });
                });
            ...
            modelBuilder.Entity("APBD_6.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPrescription = 1,
                            Date = new DateTime(2024, 6, 8, 23, 13, 24, 785, DateTimeKind.Local).AddTicks(8006),
                            DueDate = new DateTime(2024, 7, 8, 23, 13, 24, 785, DateTimeKind.Local).AddTicks(8034),
                            IdDoctor = 1,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPrescription = 2,
                            Date = new DateTime(2024, 6, 8, 23, 13, 24, 785, DateTimeKind.Local).AddTicks(8040),
                            DueDate = new DateTime(2024, 7, 8, 23, 13, 24, 785, DateTimeKind.Local).AddTicks(8041),
                            IdDoctor = 2,
                            IdPatient = 2
                        },
                        new
                        {
                            IdPrescription = 3,
                            Date = new DateTime(2024, 6, 8, 23, 13, 24, 785, DateTimeKind.Local).AddTicks(8043),
                            DueDate = new DateTime(2024, 7, 8, 23, 13, 24, 785, DateTimeKind.Local).AddTicks(8045),
                            IdDoctor = 3,
                            IdPatient = 3
                        });
                });
